...
async function generateImage(prompt: string): Promise<string | null> {
    ...
    const textPart = { text: `From the image provided, change the subject to be ${prompt}. It is critical to keep the subject's facial identity and the original background unchanged. Only alter the body's pose and expression.` };
